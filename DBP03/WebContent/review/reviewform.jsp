...
<div align = "center">
	...
	<td  colspan = "2"> <input type=checkbox name=component value=0>혈관/혈액순환</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=1>피부</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=2>소화/장</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=3>눈</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=4>피로감</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=5>뼈와 관절</td></tr>
		<tr><td colspan = "2"> <input type=checkbox name=main value=6>면역</td></tr>
